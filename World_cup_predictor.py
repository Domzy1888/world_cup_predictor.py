...
FIFA_REAL_METADATA = {
    ...
    3: {"date": "12 June", "time": "9:00 PM BST", "venue": "Toronto"},
    4: {"date": "12 June", "time": "11:30 PM BST", "venue": "Los Angeles"},
    5: {"date": "14 June", "time": "2:00 AM BST", "venue": "Boston"},
    6: {"date": "13 June", "time": "8:00 PM BST", "venue": "Vancouver"},
    7: {"date": "13 June", "time": "11:00 PM BST", "venue": "Atlanta"},
    8: {"date": "13 June", "time": "2:00 AM BST", "venue": "Dallas"},
    9: {"date": "14 June", "time": "8:00 PM BST", "venue": "Dallas"},
    10: {"date": "14 June", "time": "11:00 PM BST", "venue": "Houston"},
    11: {"date": "14 June", "time": "6:00 PM BST", "venue": "Philadelphia"},
    ...
    19: {"date": "17 June", "time": "6:00 PM BST", "venue": "Houston"},
    20: {"date": "17 June", "time": "9:00 PM BST", "venue": "Atlanta"},
    21: {"date": "17 June", "time": "12:00 AM BST", "venue": "Charlotte"},
    22: {"date": "17 June", "time": "9:00 PM BST", "venue": "Toronto"},
    23: {"date": "18 June", "time": "9:00 PM BST", "venue": "Mexico City"},
    24: {"date": "18 June", "time": "12:00 AM BST", "venue": "Guadalajara"},
    25: {"date": "19 June", "time": "6:00 PM BST", "venue": "Philadelphia"},
    26: {"date": "19 June", "time": "9:00 PM BST", "venue": "Boston"},
    27: {"date": "19 June", "time": "12:00 AM BST", "venue": "San Francisco"},
    28: {"date": "20 June", "time": "6:00 PM BST", "venue": "Guadalajara"},
    29: {"date": "20 June", "time": "9:00 PM BST", "venue": "Los Angeles"},
    30: {"date": "19 June", "time": "11:00 PM BST", "venue": "Seattle"},
    31: {"date": "21 June", "time": "5:00 PM BST", "venue": "Houston"},
    32: {"date": "21 June", "time": "8:00 PM BST", "venue": "Atlanta"},
    33: {"date": "21 June", "time": "11:00 PM BST", "venue": "Miami"},
    34: {"date": "22 June", "time": "7:00 PM BST", "venue": "Dallas"},
    35: {"date": "22 June", "time": "10:00 PM BST", "venue": "New York/NJ"},
    36: {"date": "22 June", "time": "1:00 AM BST", "venue": "Las Vegas"},
    37: {"date": "23 June", "time": "6:00 PM BST", "venue": "Boston"},
    38: {"date": "23 June", "time": "9:00 PM BST", "venue": "Toronto"},
    39: {"date": "23 June", "time": "12:00 AM BST", "venue": "Kansas City"},
    40: {"date": "24 June", "time": "6:00 PM BST", "venue": "Atlanta"},
    41: {"date": "24 June", "time": "9:00 PM BST", "venue": "Miami"},
    42: {"date": "24 June", "time": "12:00 AM BST", "venue": "Houston"},
    43: {"date": "25 June", "time": "6:00 PM BST", "venue": "New York/NJ"},
    44: {"date": "25 June", "time": "9:00 PM BST", "venue": "Philadelphia"},
    45: {"date": "23 June", "time": "9:00 PM BST", "venue": "Charlotte"},
    46: {"date": "26 June", "time": "6:00 PM BST", "venue": "Boston"},
    47: {"date": "26 June", "time": "9:00 PM BST", "venue": "Toronto"},
    48: {"date": "26 June", "time": "12:00 AM BST", "venue": "Seattle"},
    49: {"date": "24 June", "time": "11:00 PM BST", "venue": "MetLife"},
    50: {"date": "27 June", "time": "9:00 PM BST", "venue": "Orlando"},
    51: {"date": "27 June", "time": "12:00 AM BST", "venue": "Vancouver"},
    52: {"date": "27 June", "time": "12:00 AM BST", "venue": "San Francisco"},
    53: {"date": "28 June", "time": "7:00 PM BST", "venue": "Mexico City"},
    54: {"date": "28 June", "time": "7:00 PM BST", "venue": "Monterrey"},
    ...
    62: {"date": "30 June", "time": "7:00 PM BST", "venue": "Charlotte"},
    63: {"date": "30 June", "time": "12:00 AM BST", "venue": "Miami"},
    64: {"date": "30 June", "time": "12:00 AM BST", "venue": "Houston"},
    65: {"date": "1 July", "time": "6:00 PM BST", "venue": "Toronto"},
    66: {"date": "1 July", "time": "6:00 PM BST", "venue": "Montreal"},
    67: {"date": "27 June", "time": "10:00 PM BST", "venue": "San Francisco"},
    68: {"date": "1 July", "time": "11:00 PM BST", "venue": "Las Vegas"},
    69: {"date": "2 July", "time": "7:00 PM BST", "venue": "Orlando"},
    70: {"date": "2 July", "time": "7:00 PM BST", "venue": "New York/NJ"},
    71: {"date": "2 July", "time": "12:00 AM BST", "venue": "Dallas"},
...
# --- 15. ADMINISTRATIVE CONTROL PANEL ---
    ...
    with admin_tabs[1]:
        ...
        with adm_ko_tabs[3]:
            ...
            with c_p3_1:
                if not is_m103_saved:
                    if st.button("📢 Lock 3rd Place Winner", key="btn_lock_m103", use_container_width=True):
                        f_v = sf1_l if actual["ko_winners"]["Match_103"] == sf1_l else (sf2_l if actual["ko_winners"]["Match_103"] == sf2_l else None)
                        if f_v:
                            db_save_league_actual_result(active_league_id, "Match_103_winner", f_v)
                            st.rerun()
                else: st.markdown(f"<div style='color: #22c55e; font-weight: bold;'>✅ 3rd Place Locked: {actual['third_place']}</div>", unsafe_allow_html=True)
            with c_p3_2:
                if is_m103_saved and st.button("🔓 Unlock 3rd Place", key="btn_unl_m103", use_container_width=True):
            ...
            final_h = sf1_w if sf1_w else "W101"
            final_a = sf2_w if sf2_w else "W102"
            is_m104_saved = ("Match_104" in actual["ko_winners"])
            actual["ko_winners"]["Match_104"] = render_match_card(final_h, final_a, "🥇 Grand Champion Official Winner", "Match_104", disabled=is_m104_saved, score_mode=False, scores_dict=actual["ko_winners"])
            c_f1, c_f2 = st.columns(2)
            with c_f1:
                if not is_m104_saved:
                    if st.button("📢 Lock World Champion", key="btn_lock_m104", use_container_width=True):
                        f_v = 1 if actual["ko_winners"]["Match_104"] == final_h else (2 if actual["ko_winners"]["Match_104"] == final_a else 0)
                        if f_v > 0:
                            db_save_league_actual_result(active_league_id, "Match_104", f_v)
                            st.rerun()
                else: st.markdown("<div style='color: #22c55e; font-weight: bold;'>✅ World Champion Locked</div>", unsafe_allow_html=True)
            with c_f2:
                if is_m104_saved and st.button("🔓 Unlock World Champion", key="btn_unl_m104", use_container_width=True):
